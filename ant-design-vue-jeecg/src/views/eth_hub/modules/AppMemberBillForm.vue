    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="钱包余额" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="balance">
              <a-input-number v-model="model.balance" placeholder="请输入钱包余额" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="手续费" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="charge">
              <a-input-number v-model="model.charge" placeholder="请输入手续费" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="结算日" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="settleDate">
              <a-input v-model="model.settleDate" placeholder="请输入结算日"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
