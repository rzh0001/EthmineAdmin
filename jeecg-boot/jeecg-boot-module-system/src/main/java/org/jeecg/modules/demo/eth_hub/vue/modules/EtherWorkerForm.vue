    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="在线状态" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="onlineStatus">
              <j-dict-select-tag type="list" v-model="model.onlineStatus" dictCode="online_status" placeholder="请选择在线状态" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
